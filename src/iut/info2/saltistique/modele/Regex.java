    ...
    EMPLOYES {
        ...
        public String getRegex(String delimiteur) {
            return "^E\\d{6}" + delimiteur + // Identifiant : 'E' suivi de 6 chiffres
                    "[^" + delimiteur + "\\s]+" + delimiteur + // Nom : tout caractère sauf le délimiteur
                    "[^" + delimiteur + "\\s]+" + delimiteur + // Prénom : tout caractère sauf le délimiteur
    ...
    SALLES {
        ...
        public String getRegex(String delimiteur) {
            return "^([0-9]{8})" + delimiteur // Identifiant : exactement 8 chiffres
                    + "([^" + delimiteur + "\\s]+)" + delimiteur // Nom de la salle : tout caractère sauf le délimiteur
    ...
    RESERVATIONS {
        ...
        public String getRegex(String delimiteur) {
            return "^R\\d{6}" + delimiteur // Identifiant : 'R' suivi de 6 chiffres
                    ...
                    + "[^" + delimiteur + "\s]+" + delimiteur // Activité : tout sauf le délimiteur
    ...
    ORDINATEURS {
        ...
        public String getRegex(String delimiteur) {
            return "^([^;]*;){5}" + // 5 champs avant le champ ordinateur
                    ...
                    "([^" + delimiteur + "\\s]+);" + // type d'ordinateur (au moins un caractère)
